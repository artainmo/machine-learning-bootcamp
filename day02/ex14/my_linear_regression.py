...
class My_linear_regression:
    ...
    def get_gradient(self, x_values, expected_values):
        ...
        predicted_expected_difference = predicted_values - expected_values
        return x_values.dot(predicted_expected_difference) / lenght
    ...
    def cost_function(self, predicted_values, expected_values):
        ...
        return matrix.dot(matrix) / (2 * predicted_values.shape[0])
